...
class AuthManager
{
    ...
    public function __construct(AuthenticationService $authService,SessionManager $sessionManager, Container $sessionContainer, $config)
    {
    ...
    public function login($username, $password, $rememberMe)
    {
        ...
        if ($result->getCode()==Result::SUCCESS){
            $user = $this->authService->getAdapter()->getUser();
    ...
    {
        //$this->sessionManager->getStorage()->offsetSet('tus','tesaaa');
        $u = $this->sessionManager->getStorage()->offsetGet('user');
        $u = $this->sessionManager->getStorage();
        //$u = unserialize($u);
        return $u;
        //return $this->authService->getStorage()->write(tes);
        //return $this->sessionManager->getStorage()->offsetGet('user');
        //return $this->sessionManager->getStorage()->ContainerNamespace;
    }
}
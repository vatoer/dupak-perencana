 ...
 * RefKelompokKerja
 *
 * @ORM\Table(name="ref_kelompok_kerja", indexes={@ORM\Index(name="REL_ref_k_k_to_ref_o", columns={"organisasi_id"})})
 * @ORM\Entity(repositoryClass="Application\Repository\RefKelompokKerjaRepository")
 */
class RefKelompokKerja
{
    /**
     * @var string
     *
     ...
     * @var string|null
     *
     * @ORM\Column(name="parent_kelompok_kerja_id", type="string", length=36, nullable=true, options={"default"="NULL"})
     */
    private $parentKelompokKerjaId = 'NULL';
     ...
     * @var string|null
     *
     * @ORM\Column(name="akronim", type="string", length=50, nullable=true, options={"default"="NULL"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="jabatan_kepala", type="string", length=50, nullable=true, options={"default"="NULL"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="jenis_kelompok_kerja", type="string", length=36, nullable=true, options={"default"="NULL"})
     */
    private $jenisKelompokKerja = 'NULL';
    ...
    public function getParentKelompokKerjaId(): ?string
    {
        return $this->parentKelompokKerjaId;
    }

    public function setParentKelompokKerjaId(?string $parentKelompokKerjaId): self
    {
        $this->parentKelompokKerjaId = $parentKelompokKerjaId;
    ...
    public function getJenisKelompokKerja(): ?string
    {
        return $this->jenisKelompokKerja;
    }

    public function setJenisKelompokKerja(?string $jenisKelompokKerja): self
    {
        $this->jenisKelompokKerja = $jenisKelompokKerja;

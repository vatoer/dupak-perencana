...
class RefUnsur extends \Application\Entity\RefUnsur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\RefUnsur' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\RefUnsur' . "\0" . 'nama', '' . "\0" . 'Application\\Entity\\RefUnsur' . "\0" . 'keterangan', '' . "\0" . 'Application\\Entity\\RefUnsur' . "\0" . 'kodeRomawi', '' . "\0" . 'Application\\Entity\\RefUnsur' . "\0" . 'kodeAngka', '' . "\0" . 'Application\\Entity\\RefUnsur' . "\0" . 'idJabatanFungsional'];
        }
     ...
     * {@inheritDoc}
     */
    public function setIdJabatanFungsional(?\Application\Entity\RefJabatanFungsional $idJabatanFungsional): \Application\Entity\RefUnsur
    {
